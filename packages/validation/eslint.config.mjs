...
export default defineConfig(
  ...
  // — File naming  ─────
  // e.g. `receipt-payment.constant.ts` ✓   `receiptPayment.constant.ts` ✗
  {
    files: ['src/**/*.ts'],
    ...
    rules: {
      'check-file/filename-naming-convention': [
        'error',
        { '**/*.ts': 'KEBAB_CASE' },
        // ignore the role suffix (.constant / .schema / …) — only the base name is checked
  ...
  //   import { BOOKING_STATUS } from './booking...';    // parent/sibling/index
