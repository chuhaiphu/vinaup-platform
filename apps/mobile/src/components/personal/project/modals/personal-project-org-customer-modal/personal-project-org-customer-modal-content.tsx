...
interface PersonalProjectOrgCustomerModalContentProps {
...
export function PersonalProjectOrgCustomerModalContent({
  organizationName = '',
  customerName = '',
  isLoading = false,
  onSubmit,
  ref,
}: PersonalProjectOrgCustomerModalContentProps) {
