...
interface PersonalWageInfoModalContentProps {
...
export function PersonalWageInfoModalContent({
  wageDescription = '',
  wageCode = '',
  wageStartDate,
  wageEndDate,
  ...
  onSubmit,
  ref,
}: PersonalWageInfoModalContentProps) {
  const [description, setDescription] = useState(wageDescription);
  const [code, setCode] = useState(wageCode ?? '');
