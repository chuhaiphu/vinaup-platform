...
interface ReceiptPaymentListInTourImplementationProps {
...
export function ReceiptPaymentListInTourImplementation({
  receiptPayments,
  startDate,
  endDate,
  loading,
  ...
  organizationId,
  groupCode,
}: ReceiptPaymentListInTourImplementationProps) {
  ...
  return (
    <View style={styles.listContent}>
      ...
      {groupCode !== 'FOR_TOUR_GUIDE' && renderGeneralServiceReceiptPaymentsSection()}
