...
interface CarMemberSelectModalContentProps {
  isLoading?: boolean;
...
export function CarMemberSelectModalContent({
  isLoading,
  organizationMembers,
  preSelectedMemberIds,
  onSubmit,
  ref,
}: CarMemberSelectModalContentProps) {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedIds, setSelectedIds] = useState<string[]>(() => preSelectedMemberIds ?? []);
