...
export interface ReceiptPaymentListInProjectRef {
  refresh: () => void;
}

interface ReceiptPaymentListInProjectProps {
  projectId: string;
  startDate?: string;
  endDate?: string;
  onRefreshingChange?: (isRefreshing: boolean) => void;
  ref?: React.Ref<ReceiptPaymentListInProjectRef>;
}

export function ReceiptPaymentListInProject({
  projectId,
  startDate,
  endDate,
  onRefreshingChange,
  ref,
}: ReceiptPaymentListInProjectProps) {
  const router = useRouter();
  const { receiptPayments, refreshFetch, isRefreshing } = useReceiptPaymentListInProjectContext();
