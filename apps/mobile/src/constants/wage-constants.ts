import { WAGE_STATUS } from '@vinaup-platform/validation';
...
export { WAGE_STATUS } from '@vinaup-platform/validation';
export type { WageStatus } from '@vinaup-platform/validation';
