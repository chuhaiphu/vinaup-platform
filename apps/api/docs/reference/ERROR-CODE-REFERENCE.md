...
| `RESET_TOKEN_INVALID`        | 400  | `ResetTokenInvalidException`       | [`auth.service.ts`](../../src/auth/auth.service.ts) — the reset code is missing, expired, consumed, attempt-capped, or paired with an unknown email; one generic code for all, deliberately. Reserved for the reset link token too, once that flow is built |
...
| `RECEIPT_PAYMENT_CATEGORY_NOT_FOUND`     | 404  | `ReceiptPaymentCategoryNotFoundException`  | [`receipt-payment-category.service.ts`](../../src/receipt-payment/services/receipt-payment-category.service.ts), [`organization-permission.guard.ts`](../../src/_core/guards/organization-permission.guard.ts) |
...
| `error` code                          | HTTP | Exception class                         | Thrown by                                                                                     |
| ------------------------------------- | ---- | --------------------------------------- | --------------------------------------------------------------------------------------------- |
| `SIGNATURE_NOT_FOUND`                 | 404  | `SignatureNotFoundException`            | [`signature.service.ts`](../../src/signature/signature.service.ts), [`organization-permission.guard.ts`](../../src/_core/guards/organization-permission.guard.ts) |
| `SIGNATURE_ALREADY_SIGNED`            | 400  | `SignatureAlreadySignedException`       | [`signature.service.ts`](../../src/signature/signature.service.ts)                            |
| `SIGNATURE_NOT_AUTHORIZED`            | 403  | `SignatureNotAuthorizedException`       | [`signature.service.ts`](../../src/signature/signature.service.ts), [`organization-permission.guard.ts`](../../src/_core/guards/organization-permission.guard.ts) — sign/update/cancel by a non-target user |
